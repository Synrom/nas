...
class Genotype(NamedTuple):
  """
    Genotype describes a learned NN after NAS.
    (normal, normal_concat) describe which operations the normal cell chose
      and how to concatinate the final result.
    (normal, normal_concat) describe the same for the reduction cell.
    """
